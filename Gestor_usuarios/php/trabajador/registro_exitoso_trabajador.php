...
<head>
    ...
    <link rel="stylesheet" href="../User/registro_exitoso_user.css">
</head>
<body>
<header class="header">
    </header>
<div class="cuadro_mensaje">
    ...
    <a href="http://localhost/Easyjob_proyecto/Gestor_usuarios/php/trabajador/index_gestor_trabajador.php" class="link_volver">Volver al inicio</a></button>
</div>
    <footer class="footer">
