...
if (isset($_POST['update'])) {
    ...
    if (!empty($errors)) {
        ...
        // Actualizar el administrador sin mover entre tablas
        $sql_update = "UPDATE administrador SET nombres_apellidos=:nombres_apellidos, email=:email, celular=:celular, contrasena=:contrasena
                       WHERE id=:id";
    ...
    <main class="main-content">
        <div class="register-container">
            <div class="register-box">
                <h2>Edición de administradores</h2>
